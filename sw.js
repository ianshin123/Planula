/* 플래너 서비스워커.
   ...
   정적 자산은 cache-first. */
const CACHE = 'planula-v79';
const ASSETS = [
  './', './index.html', './manifest.webmanifest?v=79', './icon-192.png?v=79', './icon-512.png?v=79',
  './assets/planner-mascot-idle.png?v=79', './assets/planner-mascot-loop.gif?v=79', './assets/planner-mascot-once.gif?v=79'
];
