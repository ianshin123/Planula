/* 플래너 서비스워커.
   ...
   정적 자산은 cache-first. */
const CACHE = 'planula-v61';
const ASSETS = [
  './', './index.html', './manifest.webmanifest?v=61', './icon-192.png?v=61', './icon-512.png?v=61',
  './assets/planner-mascot-idle.png?v=61', './assets/planner-mascot-loop.gif?v=61', './assets/planner-mascot-once.gif?v=61'
];
