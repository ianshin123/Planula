/* 플래너 서비스워커.
   ...
   정적 자산은 cache-first. */
const CACHE = 'planula-v58';
const ASSETS = [
  './', './index.html', './manifest.webmanifest?v=58', './icon-192.png?v=58', './icon-512.png?v=58',
  './assets/planner-mascot-idle.png?v=58', './assets/planner-mascot-loop.gif?v=58', './assets/planner-mascot-once.gif?v=58'
];
